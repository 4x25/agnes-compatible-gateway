...
Read the
[compatibility matrix](https://github.com/4x25/agnes-compatible-gateway/blob/master/docs/compatibility.md),
[deployment guide](https://github.com/4x25/agnes-compatible-gateway/blob/master/docs/deployment.md),
and
[Deno Deploy/GHCR acceptance evidence](https://github.com/4x25/agnes-compatible-gateway/blob/master/docs/contract-results/2026-07-19-m5.md)
...
生产使用前请阅读
[兼容矩阵](https://github.com/4x25/agnes-compatible-gateway/blob/master/docs/compatibility.zh-CN.md)、
[部署指南](https://github.com/4x25/agnes-compatible-gateway/blob/master/docs/deployment.zh-CN.md)和
[Deno Deploy/GHCR 验收证据](https://github.com/4x25/agnes-compatible-gateway/blob/master/docs/contract-results/2026-07-19-m5.zh-CN.md)。
