...
| M2 — Chat 与 Images   | 🚧 进行中               | [Chat/错误实时探测通过；图片被上游 `503` 阻塞](docs/contract-results/2026-07-18-m2.zh-CN.md)                                     |
...
仍需付费或部署资源的外部验收保持未完成：M2 需要图片
URL/Base64/编辑契约成功证据；M3 需要真实 Agnes 视频闭环；M5 需要 Deno Deploy
Preview、GHCR 多架构发布成功及 `v0.1.0` 正式发布。
