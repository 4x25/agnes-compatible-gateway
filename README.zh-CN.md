...
| M2 — Chat 与 Images   | 🚧 进行中               | [Base64 映射已验证；提交后的正式 scope 两次复测均遇到上游 `503`](docs/contract-results/2026-07-18-m2.zh-CN.md)                   |
...
仍需付费或部署资源的外部验收保持未完成。M2 需要提交后的 `image-base64` scope
成功运行证据。
