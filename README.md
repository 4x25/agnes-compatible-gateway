...
| M2 — Chat and Images                    | 🚧 In progress           | [Base64 mapping verified; committed scope reruns hit upstream `503`](docs/contract-results/2026-07-18-m2.md)                             |
...
resources: M2 needs a successful committed `image-base64` scope run, M3 needs a
real Agnes video lifecycle, and M5 needs a Deno Deploy Preview, a successful
