...
| M2 — Chat and Images                    | 🚧 In progress           | [Live Chat/error and Image URL/edit passed; text-to-image Base64 remains](docs/contract-results/2026-07-18-m2.md)                        |
...
resources: M2 needs successful text-to-image Base64 contract evidence, M3 needs
a real Agnes video lifecycle, and M5 needs a Deno Deploy Preview, a successful
GHCR multi-architecture publication, and the `v0.1.0` release.
